(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@codesandbox_sandpack-client_dist_945c32._.js", {
...
"[project]/node_modules/@codesandbox/sandpack-client/dist/clients/runtime/index.mjs [app-client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
var IFrameProtocol = function() {
    ...
    IFrameProtocol.prototype.dispatch = function(message) {
        ...
        this.frameWindow.postMessage((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])({
            $id: this.channelId,
            codesandbox: true
        }, message), this.origin);
    };
...
function getTemplate(pkg, /* eslint-disable @typescript-eslint/no-explicit-any */ modules) {
    ...
    var totalDependencies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"])([], Object.keys(dependencies), true), Object.keys(devDependencies), true);
...
var SandpackRuntime = function(_super) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(SandpackRuntime, _super);
    function SandpackRuntime(selector, sandboxSetup, options) {
        ...
        if (options.teamId) {
            _this.bundlerURL = _this.bundlerURL.replace("https://", "https://" + options.teamId + "-") + "?cache=".concat(Date.now());
        }
                ...
                case "action":
                    {
                        if (mes.action === "show-error") {
                            _this.errors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"])([], _this.errors, true), [
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"])(mes)
                            ], false);
                        }
                        break;
                    }
    ...
    SandpackRuntime.prototype.updateSandbox = function(sandboxSetup, isInitializationCompile) {
        ...
        this.sandboxSetup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])({}, this.sandboxSetup), sandboxSetup);
        var files = this.getFiles();
        var modules = Object.keys(files).reduce(function(prev, next) {
            var _a;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])({}, prev), (_a = {}, _a[next] = {
                code: files[next].code,
                path: next
            }, _a));
        }, {});
        var packageJSON = JSON.parse((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"])(this.sandboxSetup.dependencies, this.sandboxSetup.devDependencies, this.sandboxSetup.entry));
        try {
            packageJSON = JSON.parse(files["/package.json"].code);
        } catch (e) {
            console.error((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])("could not parse package.json file: " + e.message));
        }
        ...
        this.dispatch({
            ...
            logLevel: (_d = this.options.logLevel) !== null && _d !== void 0 ? _d : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["S"].Info,
     ...
     */ SandpackRuntime.prototype.getCodeSandboxURL = function() {
        ...
        var paramFiles = Object.keys(files).reduce(function(prev, next) {
            var _a;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])({}, prev), (_a = {}, _a[next.replace("/", "")] = {
                content: files[next].code,
                isBinary: false
            }, _a));
        }, {});
    ...
    SandpackRuntime.prototype.getFiles = function() {
        ...
        if (sandboxSetup.files["/package.json"] === undefined) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"])(sandboxSetup.files, sandboxSetup.dependencies, sandboxSetup.devDependencies, sandboxSetup.entry);
        }
    ...
    SandpackRuntime.prototype.initializeElement = function() {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"])(this.element.parentNode, "The given iframe does not have a parent.");
...
//# sourceMappingURL=node_modules_%40codesandbox_sandpack-client_dist_945c32._.js.map